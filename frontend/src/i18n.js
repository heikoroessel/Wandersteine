const translations = {
  ...
  en: {
    ...
    homeButton: 'Search',
    stoneExplanation: 'You found a Wanderstein (traveling stone)! It is one of the stones that began their journey on 18 July 2026 at the wedding of Rieke & Leo – each one on a mission to explore the world.\n\nTake a photo of yourself or the place where you found it.\n\nMark the location.\n\nLeave a message.\n\nThen leave the stone somewhere special – so its story continues.',
    stoneTitle: 'Stone',
